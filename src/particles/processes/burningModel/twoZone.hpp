...
class TwoZone : public ablate::particles::processes::BurningProcess
{
//   public:
...
//
//    TwoZone(PetscReal convectionCoeff, PetscReal ignitionTemperature, PetscReal burnRate, PetscReal nuOx,
